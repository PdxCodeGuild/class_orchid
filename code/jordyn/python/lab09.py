...
def peaks_and_valleys():
    ...
    index = 1 #Skipping first index because it cannot be a peak or valley data point
...
peaks_valleys = [1, 2, 3, 4, 5, 6, 7, 6, 5, 4, 5, 6, 7, 8, 9, 8, 7, 6, 7, 8, 9] #Plus and Minus 1 ordered list to create peak and valley info
...
'''Version 3 does not work yet, commented out'''
