...
#convert the amount entered as a string into a float number and convert that float into an integer
amount_in_pennies = int(float(amount_entered) * 100)

print(amount_in_pennies)
